...
class FamApplicationAdmin(admin.ModelAdmin):
    list_display=('full_name','country_of_residence','primary_category','committee_score','status','submitted_at')
    search_fields=('full_name','email','country_of_residence','organisation')
    ...
    fieldsets=(
      ('Application',{'fields':('full_name','email','country_of_residence','primary_category','organisation','status','committee_score')}),
